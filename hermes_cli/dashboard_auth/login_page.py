...
See the <a href="https://github.com/9529360-cpu/stardust-hermes/blob/main/website/docs/user-guide/features/web-dashboard.md#authentication-gated-mode">dashboard
