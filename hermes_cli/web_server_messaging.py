...
_PLATFORM_OVERRIDES: dict[str, dict[str, Any]] = {
    ...
    "email": {
        ...
        "docs_url": "https://github.com/9529360-cpu/stardust-hermes/blob/main/website/docs/user-guide/messaging/index.md",
    ...
    "google_chat": {
        ...
        "docs_url": "https://github.com/9529360-cpu/stardust-hermes/blob/main/website/docs/user-guide/messaging/google_chat.md",
    },
    "wecom": {
    ...
    "weixin": {
        ...
        "docs_url": "https://github.com/9529360-cpu/stardust-hermes/blob/main/website/docs/user-guide/messaging/weixin.md",
    ...
    "teams": {
        ...
        "docs_url": "https://github.com/9529360-cpu/stardust-hermes/blob/main/website/docs/user-guide/messaging/teams.md",
    },
    ...
    "irc": {
        ...
        "docs_url": "https://github.com/9529360-cpu/stardust-hermes/blob/main/website/docs/user-guide/messaging/irc.md",
    },
    "line": {
        "description": "Use Hermes from LINE via the LINE Messaging API webhook.",
        "docs_url": "https://github.com/9529360-cpu/stardust-hermes/blob/main/website/docs/user-guide/messaging/line.md",
    },
    "ntfy": {
        "description": "Chat with Hermes over ntfy push topics (ntfy.sh or self-hosted).",
        "docs_url": "https://github.com/9529360-cpu/stardust-hermes/blob/main/website/docs/user-guide/messaging/ntfy.md",
    },
    "photon": {
        "description": "Use Hermes through iMessage via Photon's managed Spectrum platform.",
        "docs_url": "https://github.com/9529360-cpu/stardust-hermes/blob/main/website/docs/user-guide/messaging/photon.md",
    },
    "raft": {
        "description": "Join a Raft workspace as an external agent.",
        "docs_url": "https://github.com/9529360-cpu/stardust-hermes/blob/main/website/docs/user-guide/messaging/raft.md",
    },
    "simplex": {
        "description": "Talk to Hermes over SimpleX Chat via a local simplex-chat daemon.",
        "docs_url": "https://github.com/9529360-cpu/stardust-hermes/blob/main/website/docs/user-guide/messaging/simplex.md",
    },
    "yuanbao": {
    ...
    "webhook": {
        ...
        "docs_url": "https://github.com/9529360-cpu/stardust-hermes/blob/main/website/docs/user-guide/messaging/webhooks.md",
    ...
    "msgraph_webhook": {
        ...
        "docs_url": "https://github.com/9529360-cpu/stardust-hermes/blob/main/website/docs/user-guide/messaging/msgraph-webhook.md",
        "required_env": (),
    },
    "whatsapp_cloud": {
        "name": "WhatsApp Cloud API",
        "description": "Use Hermes via Meta's hosted WhatsApp Cloud API (no local bridge).",
        "docs_url": "https://github.com/9529360-cpu/stardust-hermes/blob/main/website/docs/user-guide/messaging/whatsapp-cloud.md",
    },
    "relay": {
