...
def _setup_webhooks():
    ...
    print()
    _info("   Full guide: https://github.com/9529360-cpu/stardust-hermes/blob/main/website/docs/user-guide/messaging/webhooks.md", None)
    ...
    _info(f"   1. Define webhook routes in {_dhh()}/config.yaml",
          ...
          "   https://github.com/9529360-cpu/stardust-hermes/blob/main/website/docs/user-guide/messaging/webhooks.md#configuring-routes",
          None,
