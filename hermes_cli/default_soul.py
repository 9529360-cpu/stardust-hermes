...
DEFAULT_SOUL_MD = (
    ...
    "safety-critical fact is genuinely missing. Missing secrets should use secure local credential capture or Vault "
    "resolution before chat clarification whenever available. Background work must remain observable and must not "
