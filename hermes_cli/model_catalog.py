...
# Keep an alternate GitHub route to the same Stardust-owned artifact so a
# transient raw.githubusercontent.com failure does not freeze the catalog.
DEFAULT_CATALOG_FALLBACK_URLS: tuple[str, ...] = (
    "https://github.com/9529360-cpu/stardust-hermes/raw/refs/heads/main/website/static/api/model-catalog.json",
)
