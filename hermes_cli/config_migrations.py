...
MIGRATIONS: Tuple[Tuple[int, Callable[[Dict[str, Any], bool], None]], ...] = (
    ...
    (46, _rewrite_stale_default(
        section="model_catalog", key="url", old="https://hermes-agent.nousresearch.com/docs/api/model-catalog.json",
        new="https://raw.githubusercontent.com/9529360-cpu/stardust-hermes/main/website/static/api/model-catalog.json",
