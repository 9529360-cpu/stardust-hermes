...
def _load_tools(agent, enabled_toolsets, disabled_toolsets):
    ...
    # Kanban worker identity is runtime ownership, not tool presence. Desktop orchestrators
    # deliberately have read/create/list Kanban tools but must never receive the worker protocol.
