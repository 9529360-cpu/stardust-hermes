...
from . import (  # noqa: E402
    ...
    methods_delegations as _methods_delegations,
...
for _m in (
    ...
    _methods_session_control, _methods_subagents, _methods_delegations, _methods_vault, _methods_free_tier, _methods_connectors):
