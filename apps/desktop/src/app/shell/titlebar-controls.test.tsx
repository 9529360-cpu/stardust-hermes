...
describe('titlebar app-action cluster', () => {
  ...
  it('defaults settings to the right so the left titlebar stays free for tabs', () => {
    renderControls('/')
    ...
    expect(within(right).queryByLabelText('Layout editor')).toBeNull()
    expect(within(right).queryByLabelText('HUD mode')).toBeNull()
  ...
  it('moves settings to the left when the appearance setting says left', () => {
