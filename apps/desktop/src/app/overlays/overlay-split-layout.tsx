  ...
  return (
    <main
      className={cn(
        ...
        'mx-auto flex min-h-0 w-full flex-1 flex-col overflow-hidden bg-transparent text-(--ui-text-primary) pb-2 pt-[calc((var(--titlebar-height)/2+1rem)*2/3)] max-[47.5rem]:pt-[calc(0.5rem*2/3)] px-[clamp(0.8333rem,2.6667vw,2.6667rem)]',
        PAGE_MAX_W,
        className
      )}
    >
