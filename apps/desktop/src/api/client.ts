...
export class HermesGateway extends JsonRpcGatewayClient {
  constructor() {
    super({
      closedErrorMessage: 'Stardust gateway connection closed',
      connectErrorMessage: 'Could not connect to Stardust gateway',
      createRequestId: nextId => nextId,
      notConnectedErrorMessage: 'Stardust gateway is not connected',
