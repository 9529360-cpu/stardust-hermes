...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    customEndpoints: {
      ...
      deleteFailed: '刪除服務失敗',
      emptyDescription: '可新增任何相容 OpenAI API 的模型服務。',
      emptyTitle: '尚無自訂服務',
      nameLabel: '服務名稱',
      namePlaceholder: '我的模型服務',
      endpointUrlLabel: '服務位址',
      modelLabel: '預設模型',
      apiKeyLabel: 'API 金鑰',
      apiKeyOptional: '可選',
      apiKeyKeepExisting: '留空則保留目前金鑰',
      apiKeySet: '已儲存 API 金鑰',
      makeDefault: '設為新對話預設服務',
      advanced: '進階選項',
      advancedHide: '收起進階選項',
      providerIdLabel: '服務識別碼',
      providerIdHint: '僅供內部識別，通常可以留空。',
      providerIdPlaceholder: 'my-service',
      contextLabel: '上下文長度',
      contextPlaceholder: '自動',
      discoverModels: '自動讀取模型清單',
      test: '測試連線',
      testing: '正在測試…',
      save: '儲存服務',
      saving: '正在儲存…',
    ...
    model: {
      loading: '正在載入模型服務...',
      primaryTitle: '模型服務',
      appliesDesc: '選一個服務，需要時填 API 金鑰或登入，再選擇新對話預設使用的模型。',
      provider: 'AI 服務',
      model: '模型',
      applying: '套用中...',
      ...
      currentService: '目前預設',
      serviceNotConnected: '未連接',
      modelCount: count => `可用模型 ${count} 個`,
      addService: '新增模型服務',
      ...
      moaPreset: '預設',
      moaAggregator: '聚合模型',
      moaDescription: '設定具名預設，它們會作為混合代理提供方下的模型顯示。聚合模型負責最終作答。',
      moaEnabled: '已啟用',
      moaSetDefault: '設為預設',
      moaNewPreset: '新預設',
      moaAddPreset: '新增預設',
  ...
  skills: {
    ...
    technicalDetails: '技術說明',
    skillOverview: '它能做什麼',
    skillRequirements: '執行需求',
    skillCompatibility: '支援平台',
    rawInstructions: '原始說明',
    technicalMetadata: '技術資訊',
    skillCategoryLabels: {
      apple: 'Apple',
      'autonomous-ai-agents': '自主智能體',
      blockchain: '區塊鏈',
      communication: '溝通',
      cooking: '烹飪',
      creative: '創意',
    ...
    plugins: {
      ...
      halfAgent: '智能體',
      halfAgentIn: (profile: string) => `${profile} 中的智能體`,
      defaultProfile: '預設設定',
      kindAgent: '智能體',
      kindDesktop: '桌面',
      kindBoth: '智能體 + 桌面',
      ...
      installAgentHereTip: (profile: string) =>
        `桌面部分已載入本應用，但智能體部分尚未安裝到 ${profile}。可在此安裝到該設定。`,
      ...
      loadFailed: '無法載入智能體外掛',
      toggleFailed: (name: string) => `無法切換 ${name}`,
      legacyBackend: '此後端版本較舊，不支援依鍵名切換外掛 — 請更新後再於此管理。',
      portableBadge: '可攜',
      catalogTitle: '外掛目錄',
      catalogBrowse: '瀏覽',
      catalogHide: '隱藏目錄瀏覽器',
      ...
      updated: (name: string) => `${name} 已更新到目前目錄的固定提交。重新啟動閘道後生效。`
    },
    officialCatalog: '可安裝',
    officialPill: '官方'
  },
  ...
  messaging: {
    ...
    telegramQr: {
      ...
      subtitle: '兩種方式都會連接由你控制的機器人，憑證僅儲存在本應用程式中。',
      quickSetup: '快速設定',
      recommended: '推薦',
      quickHelp: '掃描 QR 碼並在 Telegram 中確認。助理會自動建立機器人並偵測你的 Telegram 使用者 ID。',
    ...
    platformDescriptions: {
      telegram: '透過 Telegram 機器人隨時與助理對話，並接收提醒和任務結果。',
      discord: '把助理接入 Discord 伺服器或私訊，用於對話、提醒和自動任務。',
      slack: '把助理接入 Slack 工作區，在頻道和私訊中處理工作與通知。',
      mattermost: '把助理接入 Mattermost，用於團隊對話、提醒和自動任務。',
      matrix: '透過 Matrix 帳號與助理對話，並在你的 homeserver 中收發訊息。',
      signal: '透過 Signal 與助理對話，並接收提醒和任務結果。',
      whatsapp: '透過 WhatsApp 與助理對話，並接收提醒和自動任務結果。',
      bluebubbles: '透過 BlueBubbles 把 iMessage 接入助理。',
      homeassistant: '把助理接入 Home Assistant，與智慧家庭自動化聯動。',
      email: '讓助理透過電子郵件收發訊息，用於通知、回覆和自動工作流程。',
      sms: '透過 Twilio 簡訊與助理收發訊息和提醒。',
      dingtalk: '把助理接入釘釘，用於團隊訊息、提醒和自動任務。',
      feishu: '把助理接入飛書 / Lark，用於團隊訊息、提醒和自動任務。',
      wecom: '透過企業微信群機器人傳送助理訊息和自動任務結果。',
      wecom_callback: '透過企業微信自建應用程式與助理進行雙向訊息互動。',
      weixin: '透過微信與助理對話，並接收提醒和任務結果。',
      qqbot: '把助理接入 QQ 機器人，用於訊息、提醒和自動任務。',
      api_server: '透過相容 OpenAI 的 API 把助理接入其他用戶端和工具。',
      webhook: '透過 HTTP Webhook 接收外部事件並觸發助理工作流程。'
    },
    platformIntro: {
      telegram:
      ...
      dingtalk: '在開發者控制台建立釘釘應用程式，然後在此複製 Client ID（App key）和 Client Secret。',
      feishu: '建立飛書 / Lark 應用程式、設定機器人能力，再複製 App ID、App secret 和事件加密金鑰。',
      wecom: '在企業微信新增群機器人，將 webhook key 複製為 WECOM_BOT_ID。僅可傳送；雙向請使用企業微信（應用程式）。',
      wecom_callback: '設定企業微信自建應用程式、公開回呼 URL，並提供 corp ID、secret、agent ID 和 AES key。',
      weixin:
        '執行 `hermes gateway setup`，選擇 Weixin，再以個人微信帳號掃描並確認 QR 碼。本應用程式會透過騰訊 iLink Bot API 連線並儲存憑證。',
      qqbot: '在 QQ 開放平台（q.qq.com）註冊應用程式，然後複製 App ID 和 Client Secret。',
      api_server: '把助理公開為相容 OpenAI 的 API。設定驗證金鑰，再讓 Open WebUI / LobeChat 等指向 host:port。',
      webhook: '執行 HTTP 伺服器供 GitHub、GitLab 或自訂應用程式 POST，並使用 secret 驗證簽章。'
    }
  },
