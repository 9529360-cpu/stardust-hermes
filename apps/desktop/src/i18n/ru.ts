...
export const ru = defineLocale({
  ...
  settings: {
    ...
    fieldLabels: defineFieldCopy({
      ...
      memory: {
        enabled: 'Сохранение памяти',
        memoryEnabled: 'Встроенная память агента (MEMORY.md)',
        userProfileEnabled: 'Встроенный профиль пользователя (USER.md)',
        memoryCharLimit: 'Бюджет памяти',
        userCharLimit: 'Бюджет профиля',
        provider: 'Внешний провайдер памяти'
      },
      context: {
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      memory: {
        enabled:
          'Главный переключатель приватности памяти. При выключении прекращаются внедрение/запись встроенной памяти, а также инициализация, синхронизация, предварительная выборка и инструменты внешнего провайдера. Выбор провайдера и учётные данные сохраняются.',
        memoryEnabled: 'Расширенная настройка: разрешать внедрение и запись встроенного MEMORY.md только при включённом сохранении памяти.',
        userProfileEnabled: 'Расширенная настройка: разрешать внедрение и запись встроенного USER.md только при включённом сохранении памяти.',
        provider: 'Внешний провайдер, используемый при включённом сохранении памяти. Выбор сохраняется, пока память выключена.'
      },
      context: {
  ...
  cron: {
    ...
    suggestions: {
      tab: 'Предлагаемые автоматизации',
      accept: 'Запланировать',
      dismiss: 'Отклонить',
      working: 'Обработка…',
      scheduled: 'Автоматизация запланирована',
