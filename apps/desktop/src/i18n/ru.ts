...
export const ru = defineLocale({
  ...
  commandCenter: {
    ...
    maintenance: {
      ...
      resetConfirm: target => `Удалить ${target}? Это действие необратимо. Открытые чаты могут сохранять старую встроенную память до следующего хода.`,
      resetDone: (files, activeRefresh) =>
        activeRefresh
          ? `Удалено: ${files}. Открытые чаты сбросят эту встроенную память на следующем ходу; отложенные до сброса записи больше не смогут вернуть её.`
          : `Удалено: ${files}. Этот старый backend не подтвердил обновление активных чатов; начните новый чат, чтобы полностью убрать старый снимок памяти.`,
