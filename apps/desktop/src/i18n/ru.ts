...
export const ru = defineLocale({
  ...
  commandCenter: {
    ...
    maintenance: {
      ...
      resetConfirmDetail:
        'Открытые чаты могут всё ещё содержать старый замороженный снимок памяти. Граница сброса не позволит этим чатам и старым ожидающим записям вернуть забытые данные.',
      resetDone: files => `Удалено: ${files}.`,
      resetCurrentChats:
        'Открытые чаты обновят встроенную память на следующем ходе. Начните новый сеанс, чтобы сразу убрать старый снимок из prompt.',
      resetFreshTitle: 'Начать новый сеанс сейчас?',
      resetFreshDescription:
        'Новый сеанс начнётся без удалённой встроенной памяти. Текущий чат безопасен, но старый снимок может оставаться видимым до следующего обновления.',
      startFreshSession: 'Начать новый сеанс',
      keepCurrentSession: 'Оставить текущий чат',
