...
export const zh = defineLocale({
  ...
  settings: {
    ...
    uninstallSection: {
      ...
      guiOnlyTitle: '仅卸载桌面应用',
      guiOnlyDescription: '移除桌面应用；本地智能体、配置和聊天记录都会保留。',
      guiOnlyConsequence: '桌面应用及其本地应用数据',
      liteTitle: '卸载应用和智能体，保留我的数据',
      liteDescription: '移除桌面应用和本地智能体，但保留配置、聊天记录与密钥，方便以后重新安装。',
      liteConsequence: '桌面应用和本地智能体（保留配置、聊天记录与密钥）',
      fullTitle: '全部卸载',
      fullDescription: '移除应用、智能体和全部用户数据，包括配置、聊天记录、定时任务、密钥与日志。',
      fullConsequence: '全部内容——桌面应用、本地智能体、配置、聊天记录、密钥和日志',
      confirmRemoves: consequence => `将移除${consequence}。此操作无法撤销。`,
      appPathLabel: '应用',
      couldNotStart: '无法启动卸载。',
      uninstalling: '正在卸载…',
      confirmAction: '确认卸载',
      chooseDescription: '选择要移除的范围。应用会关闭以完成卸载；之后随时可以重新安装。'
    },
    poolLimits: {
    ...
    customEndpoints: {
      ...
      deleteFailed: '删除服务失败',
      emptyDescription: '可添加任何兼容 OpenAI API 的模型服务。',
      emptyTitle: '还没有自定义服务',
      nameLabel: '服务名称',
      namePlaceholder: '我的模型服务',
      endpointUrlLabel: '服务地址',
      modelLabel: '默认模型',
      apiKeyLabel: 'API 密钥',
      apiKeyOptional: '可选',
      apiKeyKeepExisting: '留空则保留当前密钥',
      apiKeySet: '已保存 API 密钥',
      makeDefault: '设为新对话默认服务',
      advanced: '高级选项',
      advancedHide: '收起高级选项',
      providerIdLabel: '服务标识',
      providerIdHint: '仅用于内部识别，通常可以留空。',
      providerIdPlaceholder: 'my-service',
      contextLabel: '上下文长度',
      contextPlaceholder: '自动',
      discoverModels: '自动读取模型列表',
      test: '测试连接',
      testing: '正在测试…',
      save: '保存服务',
      saving: '正在保存…',
    ...
    model: {
      loading: '正在加载模型服务...',
      primaryTitle: '模型服务',
      appliesDesc: '选一个服务，需要时填 API Key 或登录，再选择新对话默认使用的模型。',
      provider: 'AI 服务',
      model: '模型',
      applying: '应用中...',
      ...
      advancedModelSettingsDesc: '辅助模型和混合智能体等高级功能。日常使用通常不用修改。',
      defaultsLabel: '回答偏好',
      reasoning: '推理',
      reasoningOff: '关闭',
      ...
      moaPreset: '预设',
      moaAggregator: '聚合模型',
      moaDescription: '配置具名预设，它们会作为混合智能体提供方下的模型显示。聚合模型负责最终作答。',
      moaEnabled: '已启用',
      moaSetDefault: '设为默认',
      moaNewPreset: '新预设',
      moaAddPreset: '添加预设',
  ...
  skills: {
    ...
    technicalDetails: '技术说明',
    skillOverview: '它能做什么',
    skillRequirements: '运行要求',
    skillCompatibility: '支持平台',
    rawInstructions: '原始说明',
    ...
    plugins: {
      ...
      installAgentHereTip: (profile: string) =>
        `桌面部分已加载到本应用，但智能体部分尚未安装到 ${profile}。可在此安装到该配置。`,
      ...
      catalogHide: '隐藏目录浏览器',
      catalogHint:
        '在目录中选择插件后，经过审核的条目会以固定提交安装到所选配置。包含智能体与桌面两部分的插件可一次完成安装。',
      alreadyInstalled: (name: string) => `${name} 已安装在此配置中。`,
      catalogProvenance: (sha: string) => `从插件目录安装${sha ? `，固定提交 ${sha}` : ''}。`,
  ...
  messaging: {
    ...
    telegramQr: {
      ...
      subtitle: '两种方式都会连接一个由你控制的机器人，凭据仅保存在本应用中。',
      quickSetup: '快速设置',
      recommended: '推荐',
      quickHelp: '扫描二维码并在 Telegram 中确认。助理会自动创建机器人并识别你的 Telegram 用户 ID。',
    ...
    platformDescriptions: {
      telegram: '通过 Telegram 机器人随时与助理对话，并接收提醒和任务结果。',
      discord: '把助理接入 Discord 服务器或私信，用于对话、提醒和自动任务。',
      slack: '把助理接入 Slack 工作区，在频道和私信中处理工作与通知。',
      mattermost: '把助理接入 Mattermost，用于团队对话、提醒和自动任务。',
      matrix: '通过 Matrix 账号与助理对话，并在你的 homeserver 中收发消息。',
      signal: '通过 Signal 与助理安全对话，并接收提醒和任务结果。',
      whatsapp: '通过 WhatsApp 与助理对话，并接收提醒和自动任务结果。',
      bluebubbles: '通过 BlueBubbles 把 iMessage 接入助理。',
      homeassistant: '把助理接入 Home Assistant，与智能家居自动化联动。',
      email: '让助理通过邮箱收发消息，用于通知、回复和自动工作流。',
      sms: '通过 Twilio 短信与助理收发消息和提醒。',
      dingtalk: '把助理接入钉钉，用于团队消息、提醒和自动任务。',
      feishu: '把助理接入飞书 / Lark，用于团队消息、提醒和自动任务。',
      wecom: '通过企业微信群机器人发送助理消息和自动任务结果。',
      wecom_callback: '通过企业微信自建应用与助理进行双向消息交互。',
      weixin: '通过微信与助理对话，并接收提醒和任务结果。',
      qqbot: '把助理接入 QQ 机器人，用于消息、提醒和自动任务。',
      api_server: '通过兼容 OpenAI 的 API 把助理接入其他客户端和工具。',
      webhook: '通过 HTTP Webhook 接收外部事件并触发助理工作流。'
    },
    platformIntro: {
      telegram:
  ...
  cron: {
    ...
    botChatTarget: profile => `机器人聊天（${profile === 'default' ? '默认' : profile}）`,
    scheduleLabels: {
      daily: '每天',
      weekdays: '工作日',
      weekly: '每周',
    ...
    newCron: '新建定时任务',
    emptyDescNew: '设置一个提示词按计划自动运行。Stardust 会执行它，并把结果发送到你选择的位置。',
    ...
    createDesc: '设置一个提示词自动运行。你可以直接写“每 15 分钟”这类自然语言；自定义排程也支持 cron 语法。',
    nameLabel: '名称',
    ...
    blueprints: {
      ...
      fieldHelp: {
        time: '24 小时本地时间，例如 08:00',
        interval_min: '两次检查之间的分钟数',
        topic: '主题、产品、人物或搜索词',
        item: 'URL 或精确描述，例如型号、日期、卖家',
        condition: '价格阈值（注明货币）、可用性或条款变化',
        interval_h: '两次检查之间的小时数，请留意服务频率限制',
        companies: '使用标准公司名称和域名；别名有助于去重',
        interval_hours: '两次提醒之间的小时数',
        start_hour: '活跃时段的起始小时（24 小时制）',
        end_hour: '活跃时段的结束小时（24 小时制）'
      },
      optionLabels: {
        sunday: '周日',
        monday: '周一',
      ...
      catalog: {
        'morning-brief': {
          title: '晨间简报',
          description: '每天的简短概览：今日日程、天气和需要尽快处理的事项。'
        },
        'important-mail': {
          title: '重要邮件监控',
          description: '定期检查收件箱，只在确实需要你关注时提醒。'
        },
        'weekly-review': { title: '每周复盘', description: '回顾本周完成事项、未完成事项和接下来要做的事。' },
        'workday-start': { title: '工作日开始提醒', description: '工作日开始时提醒今日日程和最重要的优先事项。' },
        'custom-reminder': {
          title: '自定义提醒',
          description: '按你的时间安排，用自己的话设置重复提醒。',
          fields: { what: { label: '提醒我…' } }
        },
        'evening-winddown': { title: '晚间收尾', description: '一天结束时查看明日日程和今晚需要提前准备的事项。' },
        'news-digest': { title: '主题新闻摘要', description: '定期汇总你关注主题的新进展，并自动去重已发送内容。' },
        'bill-renewal-watch': {
          title: '账单与续订提醒',
          description: '在周期付款、订阅续费或到期日前提前提醒。',
        ...
        'learn-daily': { title: '每日学习', description: '每天推送一个循序渐进的短课程。' },
