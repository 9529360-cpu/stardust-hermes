...
export const ar = defineLocale({
  ...
  settings: {
    ...
    fieldLabels: {
      ...
      'memory.enabled': 'استمرارية الذاكرة',
      'memory.memoryEnabled': 'ذاكرة الوكيل المدمجة (MEMORY.md)',
      'memory.userProfileEnabled': 'ملف المستخدم المدمج (USER.md)',
      'memory.memoryCharLimit': 'ميزانية الذاكرة',
      'memory.userCharLimit': 'ميزانية الملف الشخصي',
      'memory.provider': 'مزود ذاكرة خارجي',
    ...
    fieldDescriptions: {
      ...
      'memory.enabled':
        'مفتاح الخصوصية الرئيسي للذاكرة. عند إيقافه تتوقف قراءة/كتابة الذاكرة المدمجة وكذلك تهيئة مزود الذاكرة الخارجي ومزامنته وجلبه المسبق وأدواته. يبقى اختيار المزود وبيانات اعتماده محفوظين.',
      'memory.memoryEnabled': 'إعداد متقدم: يسمح بقراءة وكتابة MEMORY.md المدمج فقط عند تشغيل استمرارية الذاكرة.',
      'memory.userProfileEnabled': 'إعداد متقدم: يسمح بقراءة وكتابة USER.md المدمج فقط عند تشغيل استمرارية الذاكرة.',
      'memory.provider': 'المزود الخارجي المستخدم عند تشغيل استمرارية الذاكرة؛ يبقى الاختيار محفوظاً عند إيقافها.',
  ...
  composer: {
    ...
    placeholderStarting: 'جار بدء المساعد...',
    placeholderReconnecting: 'جار إعادة الاتصال...',
    placeholderFollowUp: 'اكتب متابعة...',
    newSessionPlaceholders: ['اسألني عن شيء...', 'كلّفني بمهمة...', 'ابدأ محادثة جديدة...'],
