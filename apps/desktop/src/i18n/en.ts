...
export const en: Translations = {
  ...
  settings: {
    ...
    nav: {
      ...
      providerAccounts: 'Sign in',
      providerApiKeys: 'API keys',
      providerCustomEndpoints: 'Custom service',
    ...
    customEndpoints: {
      ...
      addTitle: 'Add model service',
      editTitle: 'Edit model service',
      active: 'Default',
      use: 'Set as default',
      using: 'Switching…',
      deleteEndpoint: 'Delete service',
      deleteConfirm: name => `Delete “${name}”?`,
      deleteFailed: 'Could not delete the service',
      emptyDescription: 'Add any model service with an OpenAI-compatible API.',
      emptyTitle: 'No custom services yet',
      nameLabel: 'Service name',
      namePlaceholder: 'My model service',
      endpointUrlLabel: 'Service address',
      modelLabel: 'Default model',
      apiKeyLabel: 'API key',
      apiKeyOptional: 'Optional',
      apiKeyKeepExisting: 'Leave blank to keep the current key',
      apiKeySet: 'API key saved',
      makeDefault: 'Use for new chats',
      advanced: 'Advanced options',
      advancedHide: 'Hide advanced options',
      providerIdLabel: 'Service ID',
      providerIdHint: 'Internal identifier. Usually safe to leave blank.',
      providerIdPlaceholder: 'my-service',
      contextLabel: 'Context length',
      contextPlaceholder: 'Auto',
      discoverModels: 'Automatically discover models',
      test: 'Test connection',
      testing: 'Testing…',
      save: 'Save service',
      saving: 'Saving…',
      saved: 'Model service saved.',
      newEndpoint: 'Add another service',
      loadFailed: 'Could not load custom services',
    ...
    model: {
      ...
      primaryTitle: 'Model services',
      appliesDesc: 'Pick a service, connect it if needed, then choose the model Stardust should use for new chats.',
      provider: 'AI service',
      model: 'Model',
      applying: 'Applying...',
      ...
      advancedModelSettingsDesc: 'Auxiliary models and Mixture of Agents. Most people can leave these alone.',
      defaultsLabel: 'Response preferences',
      reasoning: 'Reasoning',
      reasoningOff: 'Off',
