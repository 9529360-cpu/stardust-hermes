...
export const en: Translations = {
  ...
  settings: {
    ...
    model: {
      ...
      primaryTitle: 'Default for new chats',
      appliesDesc: 'Choose the AI service and model Stardust uses by default. You can still switch the current chat from the composer.',
      provider: 'AI service',
      model: 'Model',
      applying: 'Applying...',
