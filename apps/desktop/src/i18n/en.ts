...
export const en: Translations = {
  connectors: {
    ...
    disclaimer: 'Connecting is optional. Only authorize the apps you want Stardust to use.',
    execution: 'Connector tools'
  },

  sessionImport: {
    title: 'Continue from another app',
    subtitle: 'Bring a conversation into Stardust and pick up where you left off.',
    ...
    chooseHelp: 'Choose a session to read its history before bringing it into Stardust.',
    ...
    you: 'You',
    snapshot: 'This conversation is already in Stardust. Open your existing copy to continue.',
    copyNotice:
      'Copies conversation text. Source files stay unchanged. Tool output and reasoning are not carried over.',
    importing: 'Importing…',
    open: 'Open in Stardust',
    continue: 'Continue in Stardust',
  ...
  boot: {
    ready: 'Stardust Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Stardust settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Stardust backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Stardust Desktop…'
    },
    errors: {
      ...
      backgroundExitedDuringStartup: 'Stardust stopped right after it started.',
      backendStopped: 'Stardust stopped working in the background',
      restartHermes: 'Restart Stardust',
      openLogs: 'Open logs',
      desktopBootFailed: "Stardust couldn't start",
      gatewayConnectionLost: 'Stardust lost its connection',
      ...
      gatewaySignInRequired: 'Your remote Stardust signed you out',
      gatewaySignInRequiredDetail: 'Sign in again to reconnect. Your chats and settings are safe.',
      signInAgain: 'Sign in again',
      ipcBridgeUnavailable: "Stardust Desktop couldn't talk to its own background layer. Restart the app."
    },
    // Plain causes for a local backend boot failure (`classifyBootFailure`);
    // the raw output stays behind "Show recent logs".
    causes: {
      exitedEarly: "Stardust' background service stopped right after starting.",
      timedOut: "Stardust' background service didn't answer in time.",
      permission: "Stardust couldn't write to its data folder (permission problem).",
      diskFull: 'The disk is full, so Stardust could not start.',
      portInUse: 'Another program is using the network port Stardust needs.',
      installMissing: "Part of Stardust' installation is missing. Choose Repair install to put it back."
    },
    failure: {
      title: "Stardust couldn't start",
      description:
        "Stardust' background service didn't come up. Try one of the recovery steps below. Nothing here deletes your chats or settings.",
      details: 'Details',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Stardust backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Stardust',
    ...
    errors: {
      ...
      storageFailure: "Stardust couldn't save to its data folder. Open Maintenance to check and repair it.",
      gatewayAuthFailed:
        'This Stardust no longer accepts your saved sign-in. Open Gateways and sign in again (or paste a new access token), then retry.',
      methodNotAllowed: "Stardust' background service is out of step with the app, probably after an update. Restart it to fix this.",
      ...
      codeSkewRestartRequired: 'Stardust was updated but is still running the old version. Restart it to finish the update.',
      restartHermesFailed: "Couldn't restart Stardust"
    },
    actions: {
      restartHermes: 'Restart Stardust',
      openKeys: 'Open Keys',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Stardust defaults?',
    ...
    plugins: {
      ...
      installModal: {
        ...
        catalogPinned: (name, sha) =>
          `Stardust catalog entry "${name}" — the agent component installs at the reviewed pin${sha ? ` ${sha}` : ''}, not the branch tip.`,
    ...
    vault: {
      ...
      otpHint: 'The "setup key" the site shows when you enable 2FA. With it saved, Stardust generates the codes itself.',
      ...
      sources: {
        ...
        notInstalled: name =>
          `Not detected. Install the ${name} command-line tool and sign in to it; Stardust picks it up automatically.`,
        disabledDesc: 'Detected but turned off for Stardust.',
        lockedDesc: 'Detected. The agent will ask you to unlock it when it needs a login, or unlock now.',
        unlockedDesc: 'Unlocked for this session. Locks automatically after 30 minutes idle or when Stardust closes.',
        statusLocked: 'Locked',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Stardust is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Stardust asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Stardust was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Stardust was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Stardust follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Stardust can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'Occasional hints from the app and Stardust. Each tip appears once. Turns off automatically after your first 30 days; you can turn it back on.',
      tipsReset: (count: number) => `Show ${count} ${count === 1 ? 'tip' : 'tips'} again`,
      toursTitle: 'Guided Tours',
      toursDesc:
        'Let Stardust spotlight each step as it guides you through the app. Turns off automatically after your first 30 days; you can turn it back on.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Stardust is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Stardust, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    uninstallSection: {
      ...
      uninstallHermes: 'Uninstall Stardust'
    },
    poolLimits: {
    ...
    about: {
      heading: 'Stardust Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Stardust runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      bundleOutOfSyncAction: 'Get the installer',
      bundleSwapPending: 'Restart to finish the update',
      bundleSwapPendingDesc:
        'The updated app is already installed — Stardust only needs to restart to load it. Chats and settings are untouched.',
      bundleSwapPendingAction: 'Restart Stardust',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
      ...
      automaticUpdatesDesc:
        'Stardust checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Stardust configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Stardust.',
    ...
    connections: {
      ...
      intro: 'Manage this device and other gateways Stardust can reach through remote or SSH connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed externally',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Remote gateway',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Stardust runtime managed by this app.',
      kindRemoteDesc: 'A Stardust gateway reachable over HTTP(S) ? LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A legacy remote gateway.',
      kindSshDesc: 'A Stardust install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Stardust manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Stardust Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      unavailableDesc: 'Connection settings can only be changed from the Stardust Desktop app on the computer running it.',
      title: 'Gateway Connection',
      envOverride: 'env override',
      intro:
        'Local by default. Use remote when this app should drive a Stardust backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'This connection was fixed by the way Stardust was launched.',
      envOverrideDesc:
        'A startup setting outside the app chose this connection, so the options below are read-only. Restart Stardust without that setting — or ask whoever set it up — to change it here.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Stardust backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Stardust backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Stardust Cloud',
      cloudDesc: 'Sign in once to Stardust Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Stardust Cloud',
      cloudSignIn: 'Sign in to Stardust Cloud',
      cloudSignedIn: 'Signed in to Stardust Cloud',
      cloudNeedsSignIn: 'Sign in to Stardust Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Stardust Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Stardust Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Stardust Cloud',
      cloudSignedOutMessage: 'Cleared the Stardust Cloud session.',
      ...
      probeError: "Stardust can't reach that address. Check the URL and that the other computer is running Stardust — sign-in options appear once it answers.",
      signedIn: 'Signed in',
      signIn: 'Sign in',
      signOut: 'Sign out',
      ...
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Stardust ${version}` : ''}`,
      ...
      sshDesc:
        'Stardust is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'Stardust path (optional)',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Stardust found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Stardust runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Stardust is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the Stardust path.',
      sshErrPlatform:
        'Unsupported remote platform. Stardust Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Stardust on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Stardust. Review the exact configuration below — it comes from the link, not from Stardust.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. Stardust starts and manages the server for you.`,
    ...
    providers: {
      ...
      localEndpoint: {
        ...
        description: 'Point Stardust at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      terminalBackend: {
        ...
        unavailableMessage: backend =>
          `Stardust can't run shell commands right now: ${backend} isn't ready. Switch to Local, or finish setting up ${backend} and try again.`,
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let Stardust browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  skills: {
    ...
    plugins: {
      ...
      defaultProfile: 'Stardust (default)',
      kindAgent: 'Agent',
      kindDesktop: 'Desktop',
      ...
      legacyBackend: 'This backend predates key-addressed plugin toggles — update Stardust to manage it here.',
      ...
      catalogProvenance: (sha: string) => `Installed from the Stardust catalog${sha ? ` at pin ${sha}` : ''}.`,
  ...
  starmap: {
    ...
    emptyDesc: 'As Stardust builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Stardust to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Stardust to generate pets.',
      backgroundHint: 'You can close this — Stardust will notify you when it’s done.',
    ...
    archivedChats: 'Archived chats',
    sections: { maintenance: 'Maintenance', sessions: 'Tasks', system: 'System', usage: 'Usage' },
    sectionDescriptions: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Stardust desktop' },
    ...
    hermesActiveSessions: (version, count) => `Stardust ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    restartFailedManual: "Stardust couldn't restart to apply your messaging settings",
    ...
    telegramQr: {
      ...
      subtitle: 'Both options connect a bot you control and save its credentials only to this Stardust installation.',
      quickSetup: 'Quick setup',
      recommended: 'Recommended',
      quickHelp:
        'Scan a QR code and confirm in Telegram. Stardust creates the bot and detects your Telegram user ID automatically.',
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Stardust you point it at, instead of this computer.',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Stardust environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Stardust did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Stardust will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    noMatch: query => `No tasks match “${query}”.`,
    results: 'Results',
    pinned: 'Pinned',
    sessions: 'Tasks',
    cronJobs: 'Cron jobs',
    groupAriaGrouped: 'Show tasks as a single list',
    groupAriaUngrouped: 'Group tasks by project',
    showProjects: 'Show projects',
    showSessions: 'Show tasks',
    groupTitleGrouped: 'Ungroup tasks',
    groupTitleUngrouped: 'Group by workspace',
    allPinned: 'Everything here is pinned. Unpin a task to show it in recents.',
    shiftClickHint: 'Shift-click a task to pin',
    noWorkspace: 'No workspace',
    projectEmpty: 'No tasks yet',
    projectLoadFailed: 'Could not load tasks',
    noSessions: 'No tasks yet',
    noFilterMatches: 'No tasks match these filters',
    projects: {
      ...
      staleBackend:
        'Update the Stardust backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Stardust. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Stardust backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Stardust...',
    placeholderReconnecting: 'Reconnecting to Stardust…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Stardust a task',
      "What's on your mind?",
    ...
    voiceEngineChained: 'Speech-to-text + Stardust voice',
    voiceEngineLive: 'GPT-Live (full-duplex, delegates to Stardust)',
    ...
    attachUrlDesc: 'Stardust will fetch the page and include it as context for this turn.',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Stardust…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Stardust…',
    ...
    unsupportedMessage: 'This version of Stardust can’t update itself from inside the app.',
    connectionRetry:
      "Stardust couldn't reach the update server. Check your internet connection and try again. If you use a remote Stardust, make sure it is online.",
    connectionSettings: 'Connection settings',
    ...
    manualBody: 'You installed Stardust from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Stardust will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Stardust desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Stardust updater takes over in its own window and reopens Stardust automatically when it’s done. Please don’t reopen Stardust yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Stardust reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Stardust reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Stardust?',
    blockerBody:
      'Stardust needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Stardust',
    foreignBlockerBody:
      'Stardust can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Stardust can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  handoffTour: {
    ...
    stayTitle: 'Stardust is one click away',
    stayText: 'Switch to the setup profile and open Welcome to Stardust whenever you want a hand. It stays there.'
  },
  guidedGreeting: {
  ...
  install: {
    ...
    setupChoiceDesc:
      'Connect this app to a Stardust gateway you already run, or install Stardust locally on this computer.',
    connectExistingTitle: 'Connect to existing Stardust',
    ...
    installLocalTitle: 'Install Stardust locally',
    installLocalDesc: 'Download Stardust, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Stardust Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Stardust',
    remoteSetupDesc: 'Enter your gateway URL. Stardust Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Stardust gateway, including https:// when remote.',
    ...
    failedDesc:
      'One of the setup steps did not finish. This can happen when another copy of Stardust is running, the internet connection dropped, or antivirus blocked the installer. Close other Stardust windows, then choose Reload and retry. If it fails again, open the logs and send them to support.',
    activeDesc:
      'This is a one-time setup. The Stardust installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get Stardust set up",
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Stardust Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Stardust Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Stardust will only show the first 512 KB.`,
    ...
    web: {
      ...
      stillWorking:
        'Stardust is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      errorLayers: {
        ...
        gateway: 'Stardust hit a problem',
        generic: "Stardust couldn't finish this reply",
        provider: 'The AI service returned an error',
        runtime: 'Stardust hit a problem',
      ...
      errorLayerBodies: {
        ...
        disk: 'Your disk is full, so Stardust could not save this conversation. Free some space, then retry.',
        endpoint: "Stardust can't reach your custom model server. Check that it is running, then send your message again.",
        gateway: 'Stardust hit an internal problem starting this reply. Send your message again; if it keeps happening, send diagnostics.',
        generic: 'Something went wrong while Stardust was replying. Retry, or copy the details if it keeps happening.',
        provider: 'The AI service could not complete this request. Retry in a moment or switch provider.',
        runtime: 'Stardust hit an internal problem starting this reply. Send your message again; if it keeps happening, send diagnostics.',
      ...
      errorCodes: {
        ...
        ssl_cert_verification: {
          ...
          body: provider =>
            `Stardust could not verify the secure connection to ${provider}. Check your network or proxy settings, or switch provider, then send your message again.`
        },
        context_overflow: {
        ...
        invalid_response: {
          ...
          body: provider => `${provider} returned something Stardust could not read. Retry in a moment.`
        },
        empty_response: {
        ...
        loop_error: {
          title: 'Stardust got stuck in a loop',
          body: 'The reply kept repeating the same steps, so Stardust stopped it. Retry, or start a new chat if it happens again.'
        },
        SESSION_NOT_OWNED: {
          title: 'This chat is open somewhere else',
          body: 'This chat is currently open in another Stardust window or terminal. Close it there and send your message again, or start a new chat here.'
        },
        disk_full: {
          title: 'Disk full',
          body: 'Your disk is full, so Stardust could not save this conversation. Free some space, then retry.'
        }
      },
      errorAuthKinds: {
        api_key: {
      ...
      errorToastTitle: "Stardust couldn't finish the reply",
      errorRetry: 'Retry',
      ...
      errorOpenHermesFolder: 'Open Stardust folder',
      errorOpenHermesFolderFailed: 'Could not open the Stardust folder',
    ...
    approval: {
      gatewayDisconnected:
        'Stardust is offline right now. The command is still waiting for your answer (until the approval timeout). Reconnect, then send it again.',
      sendFailed: 'Could not send your answer',
      reconnect: 'Reconnect',
      timedOutSystemLine:
        'Approval timed out — the command was not run. Ask Stardust to try again, or raise the limit in Settings → Safety → Approval timeout.',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Stardust won’t ask again for commands like this — in this session or any future one.`,
      alwaysAllow: 'Always allow'
    },
    clarify: {
      notReady: 'Clarify request is not ready yet',
      gatewayDisconnected: 'Stardust is offline right now. Reconnect, then send it again.',
  ...
  prompts: {
    ...
    secretDesc: 'Stardust needs a credential to continue.',
    ...
    vaultSaveDesc: origin =>
      `Stardust reached a sign-in page at ${origin} and has no login for it. Enter it once here; it is encrypted on this machine and filled into the page without the model ever seeing the password.`,
    ...
    vaultCodeDesc: site =>
      `${site} is asking for a one-time code (text message, email or authenticator app). Enter it here and Stardust types it into the page; the model never sees it.`,
    vaultCodeLabel: 'Code',
    vaultCodeFootnote:
      'Tip: save the authenticator key with this login in Settings → Passwords & Logins and Stardust enters codes for you.',
    vaultCodeSkip: 'Skip',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Stardust Desktop to use Save Image.',
    restartToSaveImages: 'Restart Stardust Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: "Stardust couldn't reach your messaging connection. Start it from Settings → Messaging, then try the handoff again.",
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Stardust loads when the work calls for them.'
      },
      messaging: {
        title: 'Stardust away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Stardust made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Stardust — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
