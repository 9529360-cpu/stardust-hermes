...
export const THEME_PRESET_PALETTES = {
  ...
  stardust: {
    colors: {
      ...
      foreground: '#2b2820',
      card: '#ffffff',
      cardForeground: '#2b2820',
      muted: '#f1ede3',
      mutedForeground: '#8a8371',
      popover: '#ffffff',
      popoverForeground: '#2b2820',
      primary: '#f0b23d',
      primaryForeground: '#231f14',
      secondary: '#ece6d8',
      secondaryForeground: '#2b2820',
      accent: '#f3ead3',
      accentForeground: '#2b2820',
      border: '#e7e1d3',
      input: '#ffffff',
      ring: '#f0b23d',
      midground: '#b4761f',
      ...
      destructive: '#b3261e',
      destructiveForeground: '#ffffff',
      sidebarBackground: '#f3efe6',
      sidebarBorder: '#e7e1d3',
      userBubble: '#f3ead3',
      userBubbleBorder: '#e7d3a6'
    },
    darkColors: {
      background: '#171522',
      foreground: '#ede8dc',
      ...
      popover: '#1f1d2c',
      popoverForeground: '#ede8dc',
      primary: '#f0b23d',
      primaryForeground: '#231f14',
      secondary: '#2a2739',
      secondaryForeground: '#ede8dc',
      accent: '#332c1c',
      accentForeground: '#ede8dc',
      border: '#332f45',
      input: '#1f1d2c',
      ring: '#f0b23d',
      midground: '#f0b23d',
      midgroundForeground: '#231f14',
      composerRing: '#f0b23d',
      destructive: '#f2857a',
      destructiveForeground: '#ffffff',
      sidebarBackground: '#121020',
      sidebarBorder: '#2a2739',
      userBubble: '#2a2739',
      userBubbleBorder: '#3a3550'
    }
  },
  midnight: {
    colors: {
