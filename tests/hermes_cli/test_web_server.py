...
class TestWebServerEndpoints:
    ...
    def test_update_hermes_returns_docker_guidance_without_spawning(self, monkeypatch):
        ...
        assert "docker pull ghcr.io/9529360-cpu/stardust-hermes:latest" in data["message"]
        ...
        assert any("docker pull ghcr.io/9529360-cpu/stardust-hermes:latest" in line for line in status_data["lines"])
