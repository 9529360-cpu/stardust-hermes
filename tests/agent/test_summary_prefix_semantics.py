...
_FROZEN_PREFIX_GENERATIONS = (
    # Pre-state-authority split: same no-user-message guard, but MEMORY.md/USER.md
    # were still described as universally authoritative.
    (
        ...
        "ONLY the latest message as the active task and discard stale items "
        "from '## Historical Task Snapshot' entirely — do not 'wrap up' or "
        "'finish' work described there unless the latest message explicitly "
        "asks for it. Reverse signals in the latest message (e.g. 'stop', "
        "'undo', 'roll back', 'just verify', 'don't do that anymore', "
